...
public class RoundProgressBar extends View {
	...
	public RoundProgressBar(Context context, AttributeSet attrs, int defStyle) {
		...
		//获取自定义属性和默认值
		roundColor = mTypedArray.getColor(R.styleable.RoundProgressBar_roundColor, Color.rgb(49,220,178));
		...
		roundBgWidth = mTypedArray.getDimension(R.styleable.RoundProgressBar_roundBgWidth, 1);
	...
	protected void onDraw(Canvas canvas) {
		...
		int radius = (int) (centre - roundBgWidth/2-5); //圆环的半径
		paint.setColor(roundColor); //设置圆环的颜色
		paint.setStyle(Paint.Style.STROKE); //设置空心
		paint.setStrokeWidth(roundBgWidth); //设置圆环的宽度
		...
		//设置进度是实心还是空心
		paint.setStrokeWidth(roundBgWidth+5); //设置圆环的宽度
	...
	public void setgetRoundBgWidth(float roundBgWidth) {
		this.roundBgWidth = roundBgWidth;
	}
